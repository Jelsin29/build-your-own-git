                      ...
                      char hex_out[41])
{
    ...
    /* Collect tree entries for this level */
    ...
    while (i < end) {
        ...
        /* Find the next '/' — if present, this entry is in a subdirectory */
        ...
        if (slash == NULL) {
            ...
            /* Subdirectory — find all entries sharing this subdir prefix */
            ...
            /* Find the end of entries in this subdirectory */
            size_t sub_end = i;
            while (sub_end < end &&
            ...
            /* Convert hex SHA back to raw bytes */
            for (int j = 0; j < 20; j++) {
                unsigned int byte;
