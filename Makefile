...
SRC     = src/main.c src/repo.c src/hash.c src/object.c src/blob.c src/tree.c src/commit.c src/tui.c src/view_dashboard.c src/view_objects.c src/view_detail.c
OBJ     = $(SRC:.c=.o)
TARGET  = mygit
